// 修正版messageInputContainer - Silero VADのリセットを適切に実装
...
export const MessageInputContainer = ({ onChatProcessStart }: Props) => {
  ...
  const recreateRecognition = useCallback(() => {
    ...
    return null;
  }, [selectLanguage, getVoiceLanguageCode, clearInitialSpeechCheckTimer, stopListening, t, resetVadState]);
  ...
  const startListening = useCallback(async () => {
    ...
    resetVadState();
    console.log('👂 startListening: 音声認識を開始します - VADのリセット完了');
